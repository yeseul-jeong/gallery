...
public class PageMaker {
	 ...
	 * .queryParam("keyword", encoding(((SearchCriteria)
	 * cri).getKeyword())).build(); return uriComponents.toUriString(); }
	 */

	/*
	 * private String encoding(String keyword) { if (keyword == null ||
	 * keyword.trim().length() == 0) { return ""; }
	 * 
	 * try { return URLEncoder.encode(keyword, "UTF-8"); } catch
